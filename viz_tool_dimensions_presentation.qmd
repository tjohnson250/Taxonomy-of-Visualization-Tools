...
\[Expand to multiple slides visually demonstrating each point\]

Visualization tools vary along a number of dimensions, including:

-   User interface: GUI vs. Declarative

-   Expressiveness: Chart libraries vs. more flexible grammar-based tols

-   Data requirements: CSV, Excel, JSON, SQL DB, etc.

These differences reflect fundamental trade-offs in tool design. For instance, chart libraries are easy to use, but have limited expressiveness and flexibility.

Existing taxonomies do not capture all of the relevant dimensions of modern tools

To present a set of dimensions for categorizing, evaluating, selecting existing visualization tools and proposing new tools
