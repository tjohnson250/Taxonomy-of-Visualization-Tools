...
author: 
  - name: "Todd R Johnson"
    ...
    affiliation: UTHealth McWilliams School of Biomedical Informatics
date: 2025-11-26
...
::::: columns
::: {.column width="50%"}
### [Excel](https://www.microsoft.com/en-us/microsoft-365/excel) (GUI)
...
::: {.column width="50%"}
### [ggplot2](https://ggplot2.tidyverse.org/) (Declarative)
...
**Scenario:** Your company has 50 regional offices, with their own databases
...
::: {.column width="50%"}
### Grammar-based Tool (ggplot2/[D3](https://d3js.org/))
...
### Tool A: Excel/[Google Sheets](https://www.google.com/sheets/about/)
...
### Tool B: [Tableau](https://www.tableau.com/)
...
### Tool C: [R](https://www.r-project.org/) + ggplot2
...
-   **Direct connection** (Tableau Server/[Power BI](https://powerbi.microsoft.com/)):
    -   Automated Pipeline, Can combine multiple sources
    -   Always current data
    -   No manual steps
    -   Time: \~0 minutes/week (after setup)
-   **Programmatic access** ([Python](https://www.python.org/)/R):
    -   Automated pipeline, Can combine multiple sources
...
**Tools in taxonomy:** [Processing](https://processing.org/), [OpenGL](https://www.opengl.org/), [Prefuse](https://prefuse.org/), [VTK](https://vtk.org/), D3.js, [Protovis](https://mbostock.github.io/protovis/), ggplot2, Tableau, Excel, [Plotly Express](https://plotly.com/python/plotly-express/)
...
::: {.column width="50%"}
### Maximum (D3.js/[Vega-Lite](https://vega.github.io/vega-lite/))
...
**Example we saw earlier:** Interactive sunburst chart with [ggiraph](https://davidgohel.github.io/ggiraph/)
...
**[Matplotlib](https://matplotlib.org/) (basic)**: Individual plotting functions
...
| **Collaboration** | Shared files | Tableau Cloud/Server | [Git](https://git-scm.com/)/[GitHub](https://github.com/) | Git/GitHub |
| **Publishing** | Limited | Tableau Public/Server/Cloud | [Quarto](https://quarto.org/)/[Shiny](https://shiny.posit.co/) | Any web server |
| **Interactivity** | Limited | Full (Server) | Shiny/[Dash](https://plotly.com/dash/) | Full |
...
-   **R + ggplot2, Python, Matplotlib/[Altair](https://altair-viz.github.io/), D3.js, [Vega](https://vega.github.io/vega/), Vega-Lite**, etc.
...
-   **[Observable](https://observablehq.com/)**: High reusability + interactions + declarative
-   **[Streamlit](https://streamlit.io/)/Dash**: Code-based + GUI interfaces\
...
**Frontier**: Tools that have strong data abstraction/connectivity options, complete grammar of interaction, and AI integration

## Conclusion

-   **Jeffrey Heer's taxonomy** provided crucial foundation
-   **10-dimensional framework** captures modern tool complexity
-   **Declarative systems** (ggplot2, D3.js, Vega-Lite) offer unique advantages in reusability, reproducibility, etc.
...
This presentation was made with the help of [Claude](https://claude.ai/) and [Claude Code](https://claude.com/claude-code) using Sonnet 4.5

Source code available at: <https://github.com/tjohnson250/Taxonomy-of-Visualization-Tools/>
